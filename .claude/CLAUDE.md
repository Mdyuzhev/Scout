...
| `.env` | ✅ заполнен | `/opt/scout/.env` |
| GitHub Actions runner | ✅ `scout-homelab` запущен как systemd | сервер |
...
*Обновлено: 2026-03-16 (SC-003..SC-006 выполнены, инфраструктура деплоя настроена)*
