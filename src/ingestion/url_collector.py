...
_SYSTEM = (
    ...
    "1) статистические агентства и официальные отчёты (Росстат, ЦБ, Минэкономики), "
    "2) аналитические центры и отраслевые исследования (white papers, отчёты), "
    "3) деловые СМИ (РБК, Коммерсант, Ведомости, Reuters, Bloomberg), "
    "4) экспертные комментарии на профильных ресурсах. "
    "Избегай: Википедию, форумы, блоги, агрегаторы без собственного контента, "
